...
/**
 * Business Object de base pour des ValueObject dynamiques.
 *
 * @version 1.0
 * @author INSER SA
 */
public abstract class AbstractDynamicBO implements DynamicBO {
    ...
    public IValueObject getRecord(Object aId, ILoggedUser aUser) throws SQLException {
        ...
        throw new java.lang.UnsupportedOperationException("Method getRecord() is not supported");
    }
    ...
    public Object create(IValueObject aValueObject, ILoggedUser aUser) throws SQLException {
        ...
        throw new java.lang.UnsupportedOperationException("Method create() is not supported");
    }
    ...
    public int delete(Object aId, Timestamp aTimestamp, ILoggedUser aUser) throws SQLException {
        ...
        throw new java.lang.UnsupportedOperationException("Method delete() is not supported");
    }
    ...
    public Timestamp getTimestamp(Object aId, ILoggedUser aUser) throws SQLException {
        ...
        throw new java.lang.UnsupportedOperationException("Method getTimestamp() is not supported");
    }
    ...
    public IValueObject getInitVO(String aMode, ILoggedUser aUser) throws SQLException {
        ...
        throw new java.lang.UnsupportedOperationException("Method getInitVO() is not supported");
    }
}